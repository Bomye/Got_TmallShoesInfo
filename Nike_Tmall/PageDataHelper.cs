...
namespace Nike_Tmall
{
    class PageDataHelper
    {
        ...
        public List<urlInfo> GetIndexList(string url, int pg, List<urlInfo> list)
        {
            ...
            http.DefaultHeadInfo.cookie_collection.Add(uri, new System.Net.Cookie("_tb_token_", "HqxXhKygHMJu"));
            http.DefaultHeadInfo.cookie_collection.Add(uri, new System.Net.Cookie("cookie2", "28099bf9f2f967ae9778f2b058f640c7"));
        ...
        static void LoginHint(string url, string pageStr)
        {
            if (pageStr.Contains("<title>上天猫，就够了</title>"))
            {
                ...
                Console.ReadKey();
                GetNikeTmallData.driver.Navigate().GoToUrl(url);
                Thread.Sleep(3000);
            }
        ...
        public static GoodsInfo GotDetailData(urlInfo ui)
        {
            ...
            GetNikeTmallData.driver.Navigate().GoToUrl(detailUrl);
            LoginHint(detailUrl, GetNikeTmallData.driver.PageSource);

            HtmlAgilityPack.HtmlDocument hd = new HtmlDocument();
            hd.LoadHtml(GetNikeTmallData.driver.PageSource);
            try
            {
        ...
        static JsonInfo GetSaledData(string url)
        {
            ...
            http.DefaultHeadInfo.cookie_collection.Add(uri, new Cookie("cna", "pcNgEb7BPCgCAXM8EQb8jkWY"));
            http.DefaultHeadInfo.cookie_collection.Add(uri, new Cookie("cookie2", "5646788ff35d9d6172d36f6e2574430e"));
            http.DefaultHeadInfo.cookie_collection.Add(uri, new Cookie("t", "e6286cad28dd9b13e5e23192f5cf92bd"));
