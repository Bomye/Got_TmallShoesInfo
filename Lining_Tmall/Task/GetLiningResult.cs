...
{
    class GetLiningResult:AutoQueueTask<string>
    {
        static GetLiningResult _instance;
        public static GetLiningResult Instance
        {
            get
            {
                if (_instance == null)
                {
                    System.Threading.Interlocked.CompareExchange(ref _instance, new GetLiningResult(), null);
                }
                return _instance;
            }
        }
        ...
        {
            var first = ORMHelper.GetModel<Tmall_Detail_Lining>(" where LastUpdate > '2017-03-18 5:51:33' and LastUpdate < '2017-03-19 10:59:34'");
            Dictionary<UInt64, Tmall_Detail_Lining> dic_First = first.ToDictionary(key => key.Id, Tmall_Detail_Lining => Tmall_Detail_Lining);

            var last = ORMHelper.GetModel<Tmall_Detail_Lining>(" where LastUpdate > '2017-03-27 15:22:00' and LastUpdate < '2017-03-28 23:59:34'");
            Dictionary<UInt64, Tmall_Detail_Lining> dic_Last = last.ToDictionary(key => key.Id, Tmall_Detail_Lining => Tmall_Detail_Lining);

            List<Tmall_Detail_Lining> putAway = new List<Tmall_Detail_Lining>();
            List<Tmall_Detail_Lining> saleOut = new List<Tmall_Detail_Lining>();
            List<Tmall_Detail_Lining> onSaling = new List<Tmall_Detail_Lining>();
            #region 上架
